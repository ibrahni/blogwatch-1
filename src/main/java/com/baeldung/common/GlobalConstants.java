...
public class GlobalConstants {
  ...
  //GOOGLE tracking code on thank-you pages
    ...
    public static final String givenAllArticlesAndPages_whenAPageLoads_thenMetaOGImageAndTwitterImageExistAndPointToTheAbsolutePath = "givenAllArticlesAndPages_whenAPageLoads_ThenMetaOGImageAndTwitterImageExistAndPointToTheAbsolutePath";
